...
port = 465 # For SSL
password = "wizardcrossbow" # The email adresses password, blurred out in coursework evidence for security
...
receiver_email = "alexgowler@outlook.com" #user email address
...
def alert(message):
    ...
    with SMTP_SSL("smtp.gmail.com", port, context=context) as server:
        server.login("smart.light.alert@gmail.com", password) # Logs into gmail server
